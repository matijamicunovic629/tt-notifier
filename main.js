...
const {
    ...
    setGlobalStyles,
    createNotification
} = require('./src/Notification/index');
const {setGlobalStyle2App, createMyNotification} = require("./src/Notification");
...
const createWindow = () => {
    ...
    win.loadFile('./src/assets/html/index.html')
...
app.whenReady().then(() => {
    ...
    // Check some condition or setting
    const shouldStartMinimized = false; // Replace with actual check
